        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-3 Md: gap-8 Md:justify-center justify-items-center">
          ...
          <HTW_Container>
            ...
            <Typography variant="Text_featico">
              {" "}
              Automatisez vos paiements vers plusieurs bénéficiaires en un seul
              clic. Idéal pour les entreprises qui gèrent des paiements
          ...
          <HTW_Container>
            ...
            <Typography variant="Text_featico">
              ...
              applications via une API puissante et flexible. Une documentation
              claire et des outils dédiés aux développeurs simplifient le
          ...
          <HTW_Container>
            ...
            <Typography variant="Text_featico">
              {" "}
              Bénéficiez d’un service client réactif et personnalisé, disponible
              24h/24 et 7j/7 pourvous accompagner dans la gestion de vos
              paiements et répondre à toutes vos questions.
            </Typography>
          </HTW_Container>
        </div>
      </div>
