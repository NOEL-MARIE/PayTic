          ...
          <div className=" mb-7  ">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3  gap-8  justify-items-center">
              <HTW_Container className="Md:mt-7">
                ...
                <Typography variant="Text_featico" className="" theme="gray">
                  {" "}
              ...
              <HTW_Container>
                ...
                <Typography variant="Text_featico" theme="gray">
                  {" "}
                  Surveillez et analysez vos transactions en temps réel grâce à
                  un tableau de bord détaillé. Obtenez des insights précieux,
                  suivez vos flux financierset optimisez votre gestion de
                  trésorerie en quelques clics.
                </Typography>
              </HTW_Container>
