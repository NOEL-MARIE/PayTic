        ...
        <div className="pb-2 flex flex-col bg-feature">
          ...
          <div className="mb-7">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center">
              ...
              >
                <HTW_Container>
                <div className="bg-white w-[58] h-[58] flex items-center shadow-md justify-center rounded-lg">
                    <svg
                      width="24"
                      height="18"
                      viewBox="0 0 24 18"
